...
const NegUsers = () => {
	...
	return (
		<div className="p-2 bg-[#F7F6F0] md:p-4">
			<div className="flex items-center justify-between mb-6">
				<h1 className="text-2xl font-semibold text-[#333333]">
					Negative Users List
				</h1>
				<nav className="text-sm text-gray-500">
					<span className="text-[#333333]">Groover</span> /{" "}
					<span className="text-gray-600">Negative Users List</span>
				</nav>
			</div>
