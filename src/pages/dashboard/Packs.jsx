...
const Packs = () => {
	...
	return (
		<div className="space-y-4">
			<div>
				<h1 className="text-2xl font-semibold text-[#333333]">Packs</h1>
				<p className="text-sm text-[#333333]/60">
					Manage VIP packs, missions, pricing, and active states.
				</p>
			</div>
											...
											>
												{col.accessorKey === "id" ? (
													...
													<div className="flex items-center gap-2">
														...
														/>
														{togglingPackId === row.id && (
															<AiOutlineLoading className="animate-spin text-[#EC6345]" />
														)}
													</div>
						...
						<div className="flex items-center space-x-4 col-span-2">
							<label htmlFor="icon-upload" className="block">
								<Button
									variant="outlined"
									component="label"
									style={{ color: "#EC6345", borderColor: "#EC6345" }}
								>
									Choose File
									<input
										type="file"
